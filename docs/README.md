# Bella - Multi-agent simulation framework

# https://github.com/bellaOS/bella

# Visit https://bella.builders for support
...
- Highly extensible - create your own actions and clients to extend Bella's capabilities
...
To avoid git clashes in the core directory, we recommend adding custom actions to a `custom_actions` directory and then adding them to the `bellaConfig.yaml` file. See the `bellaConfig.example.yaml` file for an example.
...
The docusaurus server will get started and you can verify it locally at https://localhost:3000/bella.
