...
This guide covers advanced features and capabilities of Bella, including complex integrations, custom services, and specialized plugins.

## Service Integration

### Video Processing Service

Bella supports advanced video processing capabilities through the `VideoService`:

```typescript
import { VideoService } from "@bellaos/core/plugin-node";
...
```typescript
import { ImageDescriptionService } from "@bellaos/core/plugin-node";
...
```typescript
import { solanaPlugin } from "@bellaos/core/plugin-solana";
...
const customPlugin: Plugin = {
    name: "custom-plugin",
    description: "Custom Plugin for Bella",
    actions: [
        // Custom actions
    ],
    evaluators: [
...
```typescript
const debug = require("debug")("bella:advanced");
...
- [Bella in TEE](../advanced/bella-in-tee.md) for TEE integration
