...
The Core Package (`@bellaos/core`) provides the fundamental building blocks of Bella's architecture, handling essential functionalities like:
...
The AgentRuntime class serves as the central nervous system of Bella, orchestrating all major components:
