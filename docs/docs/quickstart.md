...
1. Use https://github.com/bellaOS/bella-starter

```bash
git clone git@github.com:bellaos/bella-starter.git
cd bella-starter
cp .env.example .env
...
- [Open an issue](https://github.com/bellaOS/bella/issues)
```
...
From the main repo you can also download [sample character files](https://github.com/bellaos/characters) this way:
```bash
...
[Character files](./core/characterfile.md) are where you can configure your agent's personality, lore, and capabilities via plugins. Inform bella which character you want to run:
...
If you're using the main [bella repo](https://github.com/bellaos/bella) and want to use the chat client, open a new terminal window and run the client's http server:
...
Go https://bellaos.github.io/registry/ or the [Showcase](/showcase) and search for plugins

2. CLI Interface

```bash
$ npx bellaos plugins list
```
...
| ----------- | ----------- |
| [`@bellaos/plugin-llama`](https://github.com/bellaos-plugins/plugin-llama) | Run LLM models on your local machine
| [`@bellaos/client-twitter`](https://github.com/bellaos-plugins/client-twitter) | Twitter bot integration
| [`@bellaos/client-discord`](https://github.com/bellaos-plugins/client-discord) | Discord bot integration
| [`@bellaos/client-telegram`](https://github.com/bellaos-plugins/client-telegram) | Telegram integration
| [`@bellaos/plugin-image`](https://github.com/bellaos-plugins/plugin-image) | Image processing and analysis
| [`@bellaos/plugin-video`](https://github.com/bellaos-plugins/plugin-video) | Video processing capabilities
| [`@bellaos/plugin-browser`](https://github.com/bellaos-plugins/plugin-browser) | Web scraping capabilities
| [`@bellaos/plugin-pdf`](https://github.com/bellaos-plugins/plugin-pdf) | PDF processing



### Configure Environment

There are two ways to configure bellaOS
...
### What's the difference between bella and bella-starter?
Bella-starter is a lightweight version for simpler setups, while the main bella repository includes all advanced features and a web client.
...
Join the [Discord community](https://discord.gg/bellaOS) for support and to share what you're building!
