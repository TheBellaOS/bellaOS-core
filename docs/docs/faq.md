...
### What is Bella?
Bella is an open-source framework for building AI agents that can interact on platforms like Twitter, Discord, and Telegram. It was created by Shaw and is maintained by the community.
...
### How do I use local models with Bella?
...
### How do I update Bella to the latest version?
...
### How does memory management work in BellaOS?
BellaOS uses RAG (Retrieval-Augmented Generation) to convert prompts into vector embeddings for efficient context retrieval and memory storage.
...
2. Use the [folder2knowledge](https://github.com/bellaOS/characterfile/tree/main/scripts) tool
...
1. Add the plugin to your character.json:
   ```json
   {
     "plugins": ["@bellaos/plugin-name"]
   }
   ```
2. Install the plugin: `pnpm install @bellaos/plugin-name`
...
### What's the recommended way to deploy Bella?
...
1. Use a process manager like PM2:
   ```bash
   npm install -g pm2
   pm2 start "pnpm start" --name bella
   pm2 save
   ```
...
Bella welcomes contributions from individuals with a wide range of skills:
...
- **Contribute to the development of the Bella platform**: https://github.com/bellaOS/bella
- **Help build the Bella ecosystem**: Create applications / tools, resources, and memes. Give feedback, and spread the word

#### Technical Contributions

- **Develop new actions, clients, providers, and evaluators**: Extend Bella's functionality by creating new modules or enhancing existing ones.
- **Contribute to database management**: Improve or expand Bella's database capabilities using PostgreSQL, SQLite, or SQL.js.
...
- **Translation**: Translate documentation and other materials to make Bella accessible to a global audience.
- **Domain Expertise**: Provide insights and feedback on specific applications of Bella in various fields.
