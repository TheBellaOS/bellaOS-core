...
- **[Fact Evaluator](https://github.com/bellaOS/bella/blob/main/packages/plugin-bootstrap/src/evaluators/fact.ts)**: Learns and remembers facts about users
- **[Goal Evaluator](https://raw.githubusercontent.com/bellaOS/bella/refs/heads/main/packages/plugin-bootstrap/src/evaluators/goal.ts)**: Tracks progress on objectives
...
```typescript
import { composeContext } from "@bellaos/core";
import { generateObjectArray } from "@bellaos/core";
import { MemoryManager } from "@bellaos/core";
import {
    type ActionExample,
    type IAgentRuntime,
    type Memory,
...
Source: https://github.com/bellaOS/bella/blob/main/packages/plugin-bootstrap/src/evaluators/fact.ts
...
```typescript
import { composeContext } from "@bellaos/core";
import { generateText } from "@bellaos/core";
import { getGoals } from "@bellaos/core";
import { parseJsonArrayFromText } from "@bellaos/core";
import {
    type IAgentRuntime,
    type Memory,
    ModelClass,
...
Source: https://github.com/bellaOS/bella/blob/main/packages/plugin-bootstrap/src/evaluators/goals.ts
