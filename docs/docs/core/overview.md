...
Bella is a framework for creating AI agents that can interact across multiple platforms.
...
Bella consists of these core components:
...
Here's an overview of how bella works from user input to response generation:
![](/img/overview.png)
