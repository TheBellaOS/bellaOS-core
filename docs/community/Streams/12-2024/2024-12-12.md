...
- **Shaw**: Creator of the Bella framework and founder of ai16z. Envisions AI freeing humans from routine labor.
...
1. **Bella Framework**: Open-source platform for AI agent development
...
ai16z Bella Retro Funding - December 11
...
- Proposal for Bella plugin to observe Discord activity and recommend airdrops
