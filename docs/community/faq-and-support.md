...
This page provides answers to frequently asked questions about ai16z, the Bella framework, daos.fun, and how to get support when you need it.

## General Questions

### What is ai16z?

[ai16z](https://www.daos.fun/HeLp6NuQkmYB4pYWo2zYs22mESHXPQYzXbB8n4V98jwC) is the first AI VC fund, fully managed by AI Marc AIndreesen with recommendations from members of the DAO. It is a Decentralized Autonomous Organization (DAO) on daos.fun that fosters an open-source community focused on building the Bella framework for creating AI agents. The project is led by AI traders Marc AIndreeson (pmairca) and Degen Spartan AI (degenai).
...
### What programming languages does Bella support?

The Bella framework is primarily built using TypeScript, but it also supports JavaScript and Node.js. Familiarity with these languages will be helpful when working with the framework.

### Can I use Bella to create AI agents for any platform?

Yes, Bella is designed to be platform-agnostic. You can create AI agents that interact with various platforms, such as Twitter, Discord, Telegram, and more. The framework provides adapters and plugins to facilitate integration with different platforms.

### How do I install and set up Bella?

Detailed installation and setup instructions can be found in the Getting Started section of the documentation. It covers prerequisites, installation steps, and basic configuration to help you get up and running with Bella quickly.

## Contribution and Support

### How can I contribute to the Bella framework?

There are several ways to contribute to the Bella framework, including:

- Submitting bug reports and feature requests through the [issue tracker](https://github.com/bellaos/bella/issues)
- Fixing bugs, implementing new features, and submitting pull requests on [GitHub](https://github.com/bellaos/bella)
- Improving documentation and creating tutorials to help others learn and use Bella
...
- Search the [issue tracker](https://github.com/bellaos/bella/issues) to see if your question has already been answered
...
1. Check the [issue tracker](https://github.com/bellaos/bella/issues) to see if the issue has already been reported or the feature requested
