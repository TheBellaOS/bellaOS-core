# Bella - Multi-Agent-Simulationsframework

# https://github.com/bellaos/bella

# Besuchen Sie https://bella.builders für Support
...
- Hochgradig erweiterbar - erstellen Sie eigene Aktionen und Clients zur Erweiterung von Bellas Fähigkeiten
...
Um Git-Konflikte im Core-Verzeichnis zu vermeiden, empfehlen wir, benutzerdefinierte Aktionen zu einem `custom_actions` -Verzeichnis hinzuzufügen und sie dann in der `bellaConfig.yaml`-Datei zu konfigurieren. Siehe `bellaConfig.example.yaml` als Beispiel.
