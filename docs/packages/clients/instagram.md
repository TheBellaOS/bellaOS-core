# @bellaos/client-instagram

An Instagram client implementation for BellaOS, enabling Instagram integration with support for media posting, comment handling, and interaction management.
...
```typescript
import { InstagramClientInterface } from '@bellaos/client-instagram';
