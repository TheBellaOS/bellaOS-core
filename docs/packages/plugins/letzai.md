# @bellaos/plugin-letzai

![LetzAI Logo](https://letz.ai/_next/image?url=%2FL.png&w=64&q=100)

A plugin to integrate LetzAI Image Generation capabilities into the bellaos ecosystem.
...
This plugin integrates LetzAI with Bella, enabling agents to generate images using any LetzAI Models, including the ones you may have created specifically of or for your agent.
...
```bash
pnpm install @bellaos/plugin-letzai
```
