...
```bash
pnpm install @bellaos/plugin-web-search
```
...
```typescript
import { webSearchPlugin } from "@bellaos/plugin-web-search";
...
```typescript
import { webSearch } from "@bellaos/plugin-web-search";
