# @bellaos/plugin-email-automation

AI-powered email automation plugin for Bella that intelligently detects email-worthy conversations and handles generation/delivery. This is not perfect and is simply a solid starting point, and I would encourage any and all contributions!
...
### Basic Usage
```typescript
import { emailAutomationPlugin } from '@bellaos/plugin-email-automation';

// Add to your Bella configuration
{
