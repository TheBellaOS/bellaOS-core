# @bellaos/plugin-obsidian

An Obsidian plugin for BELLA OS that provides seamless integration with Obsidian vaults, enabling powerful file and note management capabilities.
...
```bash
npm install @bellaos/plugin-obsidian
# or
yarn add @bellaos/plugin-obsidian
# or
pnpm add @bellaos/plugin-obsidian
```
...
Import and register the plugin in your Bella agent configuration:

```typescript
import { obsidianPlugin } from '@bellaos/plugin-obsidian';
...
The plugin provides several actions that can be used with BELLA OS:
...
1. Check the [documentation](https://bellaos.github.io/bella/)
2. Open an issue in the repository
3. Join our [Discord community](https://discord.gg/bellaos)
