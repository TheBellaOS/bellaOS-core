# DESK Exchange Plugin for Bella

This plugin enables interaction with the DESK Perpetual DEX through Bella, providing perpetual futures trading capabilities. Visit [DESK Exchange](https://desk.exchange/) for more details.
## Features
- 💱 Perpetual Trading
...
```json
{
    "plugins": ["@bellaos/plugin-desk-exchange"]
}
```
