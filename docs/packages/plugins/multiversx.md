# @bellaos/plugin-multiversx

MultiversX blockchain integration plugin for Bella OS that enables token management and transfers.
...
```bash
pnpm install @bellaos/plugin-multiversx
```
...
```typescript
import { multiversxPlugin } from "@bellaos/plugin-multiversx";
...
Contributions are welcome! Please see the [CONTRIBUTING.md](https://github.com/bellaOS/bella/blob/main/CONTRIBUTING.md) file for more information.
