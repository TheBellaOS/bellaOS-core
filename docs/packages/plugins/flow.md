...
A plugin for interacting with the Flow blockchain within the BellaOS ecosystem.
...
```bash
pnpm install @bellaos/plugin-flow
```
...
```typescript
import { flowPlugin } from "@bellaos/plugin-flow";
```
