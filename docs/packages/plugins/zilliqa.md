# @bellaos/plugin-zilliqa

A plugin for integrating Zilliqa blockchain capabilities through the GOAT (Great Onchain Agent Toolkit) framework within the BellaOS ecosystem.
...
This plugin integrates the GOAT Zilliqa plugin and wallet with Bella.

## Installation

```bash
pnpm install @bellaos/plugin-zilliqa
```
