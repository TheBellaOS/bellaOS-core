# @bellaos/plugin-messari-ai-toolkit

A powerful Bella OS plugin that integrates Messari's AI Toolkit to provide advanced crypto market research capabilities to your Bella agent.

## Overview

This plugin connects your Bella agent to Messari's comprehensive AI-powered APIs, enabling sophisticated crypto research and market analysis capabilities. It intelligently detects and processes research questions from conversations, leveraging Messari's proprietary data and expertise.

## Demo

https://github.com/messari/plugin-messari-ai-toolkit/blob/master/.github/assets/bella-tutorial.mp4
...
1. First, clone either:
   - The main Bella repository: [github.com/bellaOS/bella](https://github.com/bellaOS/bella)
   - OR the Bella starter repository: [github.com/bellaOS/bella-starter](https://github.com/bellaOS/bella-starter)
...
> Note: For the latest plugin mappings and compatibility information, refer to the [bella-plugins registry](https://github.com/bellaos-plugins/registry/blob/645ba61508a7404c5b890f47e43c005448592510/index.json#L60).
...
1. Import and register the plugin with your Bella agent
