# Hyperliquid Plugin for Bella

This plugin enables interaction with the Hyperliquid DEX through Bella, providing spot trading capabilities.
...
```json
{
    "plugins": ["@bellaos/plugin-hyperliquid"]
}
```
