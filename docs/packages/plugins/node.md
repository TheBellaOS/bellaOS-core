...
- https://github.com/bellaos-plugins/plugin-pdf
- https://github.com/bellaos-plugins/plugin-llama
- https://github.com/bellaos-plugins/plugin-image
- https://github.com/bellaos-plugins/plugin-aws-s3
- https://github.com/bellaos-plugins/plugin-browser
- https://github.com/bellaos-plugins/plugin-speech-tts

# @bellaos/plugin-node

Core Node.js plugin for Bella OS that provides essential services and actions for file operations, media processing, and cloud integrations.
...
```typescript
process.env.DEBUG = "bella:plugin-node:*";
```
