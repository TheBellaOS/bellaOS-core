# @bellaos/plugin-aptos

A plugin for interacting with the Aptos blockchain network within the BellaOS ecosystem.
...
```bash
pnpm install @bellaos/plugin-aptos
```
