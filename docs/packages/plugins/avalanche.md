# @bellaos/plugin-avalanche

A plugin for interacting with the Avalanche blockchain network within the BellaOS ecosystem.
...
```bash
pnpm install @bellaos/plugin-avalanche
```
