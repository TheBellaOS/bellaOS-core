...
📖 [Dokumentacja](https://bellaos.github.io/bella/) | 🎯 [Przykłady](https://github.com/thejoven/awesome-bella)
...
Następnie zapoznaj się z [Dokumentacją](https://bellaos.github.io/bella/). Tam jest szcegółowo opisane, jak modyfikować i dopasować Elizę do własnych potrzeb.
...
[![Otwórz w Gitpodzie](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/bellaos/bella/tree/main)
...
- [GitHub Issues](https://github.com/bellaos/bella/issues). Korzystaj w przypadku gdy napotkasz na jakieś bugi podczas uzywania Elizy, lub masz jakieś propozycje rozwoju.
...
[![Wykres historii gwiazdek](https://api.star-history.com/svg?repos=bellaos/bella&type=Date)](https://star-history.com/#bellaos/bella&Date)
