...
📖 [Документация](https://bellaos.github.io/bella/) | 🎯 [Примеры](https://github.com/thejoven/awesome-bella)
...
- [GitHub Issues](https://github.com/bellaos/bella/issues). Лучше всего подходит для: сообщений об ошибках при использовании Bella и предложений новых функций.
...
[![График истории звёзд](https://api.star-history.com/svg?repos=bellaos/bella&type=Date)](https://star-history.com/#bellaos/bella&Date)
