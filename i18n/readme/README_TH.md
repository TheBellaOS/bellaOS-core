...
📖 [คู่มือ](https://bellaos.github.io/bella/) | 🎯 [ตัวอย่าง](https://github.com/thejoven/awesome-bella)
...
จากนั้นอ่าน [คู่มือ](https://bellaos.github.io/bella/) เพื่อศึกษาวิธีการปรับแต่ง Bella

### เริ่มใช้งาน Bella ด้วยตนเอง (แนะนำสำหรับคนที่มีประสบการณ์)
...
### เริ่มใช้งาน Bella ผ่าน Gitpod

[![เปิดใน Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/bellaos/bella/tree/main)
...
### เริ่มใช้งาน Bella แบบอัตโนมัติ
...
- [GitHub Issues](https://github.com/bellaos/bella/issues). เหมาะสำหรับ: เมื่อปัญหาที่พบเมื่อใช้ Bella และข้อเสนอแนะเกี่ยวกับฟีเจอร์เพิ่มเติม
