...
📖 [Tài liệu](https://bellaos.github.io/bella/) | 🎯 [Ví dụ](https://github.com/thejoven/awesome-bella)
...
Sau đó hãy đọc [Tài liệu](https://bellaos.github.io/bella/), để học cách để tùy chỉnh Bella của bạn.

### Khởi động Bella theo cách thủ công (Chỉ khuyến khích nếu bạn biết mình đang làm gì)
...
### Bắt đầu Bella với Gitpod

[![Mở Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/bellaos/bella/tree/main)
...
### Bắt đầu Bella theo cách thủ công
...
- [GitHub Issues](https://github.com/bellaos/bella/issues). Phù hợp nhất cho: các lỗi bạn gặp phải khi sử dụng Bella và các đề xuất tính năng.
