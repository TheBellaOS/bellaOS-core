...
bellaLogger.info("Loading embedding settings:", {
...
bellaLogger.debug("Loading character settings:", {
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        bellaLogger.log(`Loaded .env file from: ${envPath}`);
    }
...
bellaLogger.info("Parsed settings:", {
