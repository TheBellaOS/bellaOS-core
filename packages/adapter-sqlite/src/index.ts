    ...
    implements IDatabaseCacheAdapter
{
    ...
    async searchKnowledge(params: {
        ...
        try {
            ...
            bellaLogger.error("Error in searchKnowledge:", error);
            throw error;
        }
    }
    ...
    async createKnowledge(knowledge: RAGKnowledgeItem): Promise<void> {
        try {
            ...
            if (isShared && isPrimaryKeyError) {
                ...
                bellaLogger.error(`Error creating knowledge ${knowledge.id}:`, {
                    error,
        ...
        try {
            ...
            await this.db.transaction(() => {
                if (id.includes("*")) {
                    ...
                    bellaLogger.debug(`[Knowledge Remove] Checking existence with:
                        Main: ${selectSql} [${id}]
                        Chunks: ${chunkSql} [${id}]`);
                    ...
                    bellaLogger.debug(`[Knowledge Remove] Found:`, {
            ...
            bellaLogger.error("[Knowledge Remove] Error:", {
                id,
                error:
...
const sqliteDatabaseAdapter: Adapter = {
    init: (runtime: IAgentRuntime) => {
        ...
        bellaLogger.info(`Initializing SQLite database at ${filePath}...`);
        ...
        db.init()
            ...
            .catch((error) => {
                bellaLogger.error("Failed to connect to SQLite:", error);
            });
