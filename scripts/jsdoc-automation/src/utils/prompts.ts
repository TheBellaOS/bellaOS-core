...
export const PROMPT_TEMPLATES = {
    ...
    Actions are core building blocks in Bella that define how agents respond to and interact with messages. They allow agents to interact with external systems, modify their behavior, and perform tasks beyond simple message responses.
        Overview
...
- Ask your questions at https://bella.gg/ 🚀 or in our discord
